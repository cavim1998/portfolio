...
function HeroSection() {
  const goDownload = () => {
    const url =
      "https://drive.google.com/file/d/1BNkhICS40Abivm4B-vE6WZlFlhXWILIq/view?usp=sharing";
    ...
    <div id="hero-section" className="container mx-auto mt-20">
      <div className="flex flex-col items-center">
        ...
        <div className="mt-10 space-x-4">
          <button
            className="hover:border hover:border-white rounded-lg hover:cursor-pointer px-6 py-3 bg-white text-black hover:bg-black hover:text-white"
            onClick={scrollToContact}
          >
            Contact Me
          </button>
          <button
            className="border border-white rounded-lg hover:cursor-pointer px-6 py-3 hover:bg-white hover:text-black"
            onClick={goDownload}
          >
            Download CV
          </button>
